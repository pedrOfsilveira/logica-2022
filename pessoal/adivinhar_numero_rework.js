...
while (dnv == 1) {
  ...
  while (vida > 1 && c_errado == 0) {
    if (ans == n) {
      ...
      if (ans > n) {
        ans = parseInt(prompt('Muito alto!\nTente de novo: '));
      } else {
        ans = parseInt(prompt('Muito baixo!\nTente de novo: '));
      }
    }
  }
  ...
  if (modo == 2) {
    if (lvl == 1) {
      ...
      n = parseInt(Math.random() * 11);
      ans = parseInt(
        prompt('Jogador 1: Tente adivinhar um número de 0 a 10: ')
      );
    } else if (lvl == 2) {
      vida1 = 5;
      vida2 = 5;
      n = parseInt(Math.random() * 51);
      ans = parseInt(
        prompt('Jogador 1: Tente adivinhar um número de 0 a 50: ')
      );
    } else if (lvl == 3) {
      vida1 = 10;
      vida2 = 10;
      n = parseInt(Math.random() * 101);
      ans = parseInt(
        prompt('Jogador 1: Tente adivinhar um número de 0 a 100: ')
      );
    }
  }
  while ((vida1 >= 1 || vida2 >= 1) && c_errado == 0) {
    if (ans == n && c_errado != 1) {
      ...
      if (vida1 == 0) {
        ...
        if (vida2 == 1) {
          ans = parseInt(
            prompt('Sua última tentativa, Jogador 2! Sem dicas. ')
          );
        }
      } else {
    ...
    if (ans == n && c_errado != 1) {
      ...
      if (vida2 == 0) {
        ...
        if (vida1 == 1) {
          ans = parseInt(
            prompt('Sua última tentativa, Jogador 1! Sem dicas. ')
          );
        }
      } else if (c_errado == 0) {
